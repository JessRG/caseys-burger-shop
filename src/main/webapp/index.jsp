...
<div class="container">
                ...
                <div class="list-group">
                    <ul>
                        <c:forEach var="ingredient" items="${burger.ingredients}">
                            <li class="list-group-item list-group-item-action"><strong>${ingredient.name}</strong></li>
                        </c:forEach>
                    </ul>
                </div>
            </c:forEach>
    ...
    <div class="list-group">
        <ul><!-- Start of our Soda List -->
            <%-- Loop through the "allSodas" attribute to display each burger --%>
            <c:forEach var="soda" items="${allSodas}">
                <li class="list-group-item list-group-item-action"><strong>${soda.name}</strong> <strong>(${soda.size})</strong></li>
            </c:forEach>
        </ul><!-- End of our Burger List -->
    </div>
</div>
